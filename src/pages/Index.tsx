    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
      <div className="absolute inset-0 bg-ink-900">
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 28%, hsl(40 45% 58% / 0.32) 0%, transparent 52%), radial-gradient(circle at 80% 80%, hsl(40 30% 40% / 0.18) 0%, transparent 40%)',
          }}
        />
        <img
          src={capiMascot}
          alt=""
          className="pointer-events-none absolute left-1/2 top-[8%] h-[min(52vh,420px)] w-auto -translate-x-1/2 object-contain opacity-[0.18] sm:top-[6%] sm:opacity-[0.22]"
        />
